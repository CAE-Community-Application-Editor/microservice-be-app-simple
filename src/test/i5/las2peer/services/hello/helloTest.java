...
/**
 *
 * be-app-simple - Test Class
 *
 * This class provides a basic testing framework for the microservice be-app-simple. It was
...
public class helloTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(hello.class.getCanonicalName(),"0.1");
  ...
  /**
   * 
   * Test for the helloWorld method.
   * 
   */
  @Test
  public void testhelloWorld() {
    ...
    try {
      ...
      System.out.println("Result of 'testhelloWorld': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
